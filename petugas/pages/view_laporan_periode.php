...
<head>
  ...
  <title>Argon - Inventaris SMK</title>
...
<body>
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="admin.php">
                ...
                <span class="nav-link-text text-secondary"><b>Barang</b></span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="admin.php">
                <i class="ni ni-bullet-list-67 text-yellow"></i>
                <span class="nav-link-text text-secondary"><b>Jenis</b></span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="admin.php">
                <i class="ni ni-building text-green"></i>
                <span class="nav-link-text text-secondary"><b>Ruang</b></span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="#navbar-examples" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="navbar-examples">
                <i class="ni ni-archive-2 text-orange"></i>
                <span class="nav-link-text text-secondary"><b>Laporan</b></span>
              </a>
              <div class="collapse" id="navbar-examples">
                <ul class="nav nav-sm flex-column">
                  <li class="nav-item">
                    <a href="../examples/pricing.html" class="nav-link text-secondary">Semua Barang</a>
                  </li>
                  <li class="nav-item">
                    <a href="../examples/login.html" class="nav-link text-secondary">Lihat Barang per Periode</a>
                  </li>
                  <li class="nav-item">
                    <a href="../examples/register.html" class="nav-link text-secondary">Barang Habis</a>
                  </li>
                </ul>
              </div>
            </li>
              ...
              <a class="nav-link pr-0" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <div class="media align-items-center">
                  ...
                  <div class="media-body ml-2 d-none d-lg-block">
                    <span class="mb-0 text-sm  font-weight-bold"><?php echo $Auth['nama_petugas'] ?></span>
                  </div>
                </div>
              </a>
        ...
        <div class="row align-items-center justify-content-lg-between">
          <div class="col-lg-6">
            <div class="copyright text-center text-lg-left text-muted">
              &copy; <script>document.write(new Date().getFullYear());</script> <a href="#" class="font-weight-bold ml-1">Creative Tim</a>
            </div>
          </div>
          <div class="col-lg-6">
  ...
  <!-- SweetAlert JS -->
  <script src="s../assets/js/plugins/sweetalert.min.js"></script>
