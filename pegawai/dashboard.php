<?php 
  ...
  $iv = new KONTROLER();
  session_start();
  $Auth = $iv->AuthPegawai($_SESSION['username']);
  $ugh = $iv->selectWhere("pegawai","username",$_SESSION['username']);
  ...
  <body class="app sidebar-mini rtl">
    ...
    <aside class="app-sidebar">
      <div class="app-sidebar__user">
        <div>
          <p class="app-sidebar__user-name"><?= $ugh['nama_pegawai'] ?></p>
          <p class="app-sidebar__user-designation">Pegawai</p>
        </div>
      </div>
      <ul class="app-menu">
